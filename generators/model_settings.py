...
MODEL_POOL = {
    ...
    'stylegan2_ffhq': {
        ...
        'model_path': MODEL_DIR + '/StyleGAN2-ADA_ffhq.pkl',
        'gan_type': 'stylegan2',
        'dataset_name': 'ffhq',
        'latent_space_dim': 512,
        'w_space_dim': 512,
    ...
    'stylegan3_ffhq': {
        'tf_model_path': MODEL_DIR + '/stylegan3-r-ffhq-1024x1024.pkl',
        'model_path': MODEL_DIR + '/stylegan3-r-ffhq-1024x1024.pkl',
        'gan_type': 'stylegan3',
        'dataset_name': 'ffhq',
        'latent_space_dim': 512,
        'w_space_dim': 512,
