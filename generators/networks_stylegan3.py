...
import torch
from generators.torch_utils import misc
from generators.torch_utils import persistence
from generators.torch_utils.ops import conv2d_gradfix
from generators.torch_utils.ops import filtered_lrelu
from generators.torch_utils.ops import bias_act
    ...
    def __init__(self,
        ...
        **layer_kwargs,                 # Arguments for SynthesisLayer.
        ...
        for idx in range(self.num_layers + 1):
            prev = max(idx - 1, 0)
            is_torgb = True     # (idx == self.num_layers)
